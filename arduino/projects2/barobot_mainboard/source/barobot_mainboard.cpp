...
*/
	...
	}else if(command == METHOD_MSET_LED ) {    // L12,0xff,0		// zga� wszystkie na upanelu 0x0C
		...
		defaultResult = false;
	}else if(  command == 'P' ) {    	// P1; P2,0; P3,1; P4,1;   - programuj urzadzenie 0x0A z prędkosca 19200, PROG 0,0 - force first, PROG 0A,0 - wozek
