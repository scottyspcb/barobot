...
import com.barobot_graph.Arduino;
import com.barobot_graph.BGraph;
import com.barobot_graph.Constant;
import com.barobot_graph.input_parser;
...
public class BT_wire implements Wire {
	private BluetoothAdapter mBluetoothAdapter = null; // Local Bluetooth
														// adapter
	private BluetoothChatService mChatService = null; // Member object for the
														// chat services
	...
	//			Arduino.getInstance().setupBT(barobotMain);
				...
				barobotMain.startActivityForResult(enableIntent,
	...
	public boolean send(String command) {
		if (mChatService != null
				&& mChatService.getState() == Constant.STATE_CONNECTED) {
	...
	public final Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case Constant.MESSAGE_DEVICE_NAME:
				...
				mChatService.bt_connected_device = msg.getData().getString(
						Constant.DEVICE_NAME);
				mChatService.is_connected = true;
				// Activity act1 = BGraph.getInstance();
				// Toast.makeText( act1.getApplicationContext(), "Connected to "
				// + mChatService.bt_connected_device,
				// Toast.LENGTH_SHORT).show();
				break;
			case Constant.MESSAGE_TOAST:
				Activity act2 = BGraph.getInstance();
				// Toast.makeText( act2.getApplicationContext(),
