...
import com.barobot_graph.R.id;
import com.barobot_graph.R.layout;
import com.barobot_graph.R.string;
...
public class BTListActivity extends Activity {
	...
	private void doDiscovery() {
		Constant.log(Constant.TAG, "doDiscovery()");
	...
	protected void onDestroy() {
		...
		if (mBtAdapter != null) {
			if (mBtAdapter.isDiscovering()) { // Always cancel discovery because
												// it will slow down a
												// connection
				mBtAdapter.cancelDiscovery();
			}
