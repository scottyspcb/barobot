...
private int suffix;
  ...
  public void onPictureTaken(byte[] data, Camera camera) {
    ...
    if (!pictureFileDir.exists() && !pictureFileDir.mkdirs()) {
      Log.d("+photoerror", "Can't create directory to save image.");
    ...
    try {
		...
		String date = dateFormat.format(new Date()) +  this.suffix ;
    ...
    //  Toast.makeText(context, "New Image saved:" + filename,Toast.LENGTH_LONG).show();
     ...
     // Log.d("+photoerror", "File" + filename + "not saved: " + error.getMessage());
